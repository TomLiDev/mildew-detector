...
Navigation option for Mildew Detector Page|Redirects to Mildew Detector page|Clicked Mildew Detector radio button option|Redirected to Mildew Detector page|Pass
Navigation option for Project Hypotheses Page|Redirects to Project Hypotheses page|Clicked Project Hypotheses radio button option|Redirected to Project Hypotheses page|Pass
...
Healthy leaf .png prediction probability figure|Figure showing prediction probability in green bar graph displayed|Upload healthy leaf .png image|Figure showing prediction probability in green bar graph displayed|Pass
...
Download Prediction Report|Downloads an excel file containing the predictions on uploaded image(s)|Clicked download report button after uploading image|Excel file downloaded which contains the predictions and details of the image files uploaded|Pass
...
Navigation option for Leaf Visualiser Page|Redirects to Leaf Visualisation page|Clicked Leaf Visualisation radio button option|Redirected to Leaf Visualisation page|Pass
Navigation option for Mildew Detector Page|Redirects to Mildew Detector page|Clicked Mildew Detector radio button option|Redirected to Mildew Detector page|Pass
Navigation option for Project Hypotheses Page|Remains to Project Hypotheses page|Clicked Project Hypotheses radio button option|Remained to Project Hypotheses page|Pass
...
Navigation option for Leaf Visualiser Page|Redirects to Leaf Visualisation page|Clicked Leaf Visualisation radio button option|Redirected to Leaf Visualisation page|Pass
Navigation option for Mildew Detector Page|Redirects to Mildew Detector page|Clicked Mildew Detector radio button option|Redirected to Mildew Detector page|Pass
Navigation option for Project Hypotheses Page|Redirects to Project Hypotheses page|Clicked Project Hypotheses radio button option|Remained to Project Hypotheses page|Pass
