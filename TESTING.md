...
An ongoing issue throughout the development of this project was ensuring correct compatibility of the various libraries being used in conjunction with each other. Whilst the combination of versions captured in the requirements.txt now allow all necessary functions and actions to be carried out, it took considerable time to find the right combination. 
